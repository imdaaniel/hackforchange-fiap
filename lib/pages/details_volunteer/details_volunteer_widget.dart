...
import 'details_volunteer_model.dart';
export 'details_volunteer_model.dart';

class DetailsVolunteerWidget extends StatefulWidget {
  const DetailsVolunteerWidget({Key? key}) : super(key: key);

  @override
  _DetailsVolunteerWidgetState createState() => _DetailsVolunteerWidgetState();
}

class _DetailsVolunteerWidgetState extends State<DetailsVolunteerWidget>
    with TickerProviderStateMixin {
  late DetailsVolunteerModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => DetailsVolunteerModel());
